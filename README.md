...
PETRA ships with **20 end-to-end scenarios** under
...
examples/             # 20 end-to-end scenarios — see docs/WORKED_EXAMPLES.md
...
4. [`docs/WORKED_EXAMPLES.md`](docs/WORKED_EXAMPLES.md) — the
   twenty scenarios under `examples/` sorted by the use case
...
```
python -m pytest                          # full suite (~484 tests)
