...
PETRA ships with **17 end-to-end scenarios** under
...
examples/             # 17 end-to-end scenarios — see docs/WORKED_EXAMPLES.md
...
4. [`docs/WORKED_EXAMPLES.md`](docs/WORKED_EXAMPLES.md) — the
   seventeen scenarios under `examples/` sorted by the use case
...
```
python -m pytest                          # full suite (~468 tests)
